...
This library is based in flowparser by Alejandro Perez Villegas (alextoni@gmail.com)

Coded by: Jose Manuel Garcia Gimenez (jgarciag@ugr.es)
...
class Variable(object):
	...
	def belongs(self, start, end):
		...
		end   -- Final value of the interval (excluvive).
...
class Record(object):
	...
	Each variable will be later used to define one or more variables.
	For simplicity, a record should contain only those variables necessary
...
class Observation(object):
	...
	def write(self, outstream):
		...
		# 	outstream.write(str(self.observations[obsKey].ID) + ', ' + self.observations[obsKey].formatCSV())
