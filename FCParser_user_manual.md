...
In this example, entry log number number 34 is loaded due to the use of go command. All the data is correctly parsed but dst_port variable, which is set to None. This happened because the regular expression used to define this variable was not properly defined.\<br />
